...
def main():
    x_start = (14, 17)  # Starting node
    x_goal = (24, 17)  # Goal node

    rrt_star = RrtStar(x_start, x_goal, 10, 0.10, 20, 10000)
    rrt_star.planning()
    final_path_length = sum(
        math.hypot(rrt_star.path[i][0] - rrt_star.path[i + 1][0], rrt_star.path[i][1] - rrt_star.path[i + 1][1])
