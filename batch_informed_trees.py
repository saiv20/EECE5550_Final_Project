...
def main():
    ...
    bit.planning()
    # Calculate and print the final path length
    final_path_length = bit.g_T[bit.x_goal]
...
'''
The simulator is based on https://github.com/zhm-real/PathPlanning
'''